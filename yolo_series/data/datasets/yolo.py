...
from yolo_series.classes.coco import COCO
from yolo_series.data.augmentations import TrainAugPipeline
from yolo_series.data.datasets.datasets_wrapper import Dataset
from yolo_series.utils.bboxes import xywhn_to_xyxy, xyxy_to_xywhn
from yolo_series.utils.general import exif_size
...
class YOLODataset(Dataset):
    def __init__(
        ...
        self.class_ids = [i for i in range(class_lbls)]
    ...
    def __getitem__(self, index):
        img, targets, orig_sz, idx = self.pull_items(index)
